...
Admin › **Joueurs** : tout le profil de chaque joueur est modifiable (points, victoires, parties, jetons, points de saison, XP du pass, essences, persos débloqués (`persosDebloques` = `cleP(perso)`), skins par perso, niveau/points par perso).
